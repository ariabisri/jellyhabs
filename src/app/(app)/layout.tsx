...
function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between border-b border-border bg-card/60 backdrop-blur-md px-4 md:px-6 transition-colors duration-300">
      ...
      <div className="flex items-center gap-3">
        <button
          className="relative flex size-9 items-center justify-center rounded-full border border-border bg-card/80 text-foreground hover:bg-accent/20 transition-all"
        ...
        {loading ? (
          <div className="hidden sm:flex items-center gap-2 border-l border-border pl-3 ml-1 text-xs text-muted-foreground">
